...
- **7-ink CMYKOGV (APTEC, coated)** — ICC registry:
  ...
  (downloaded to `journal/data/raw/ncolor/APTEC_CMYKOGV_7clr_xyzlab.txt`; XYZ+Lab, 3534 patches —
  the file header's NUMBER_OF_SETS 1624 is stale; 3302 effective after exact-dedup at load)
