...
# Main function to run color mapping with Gradient Boosting Machine
def run_color_mapping():
    ...
    for index, config in enumerate(configurations):
        model = config['model'](n_estimators=config['n_estimators'], learning_rate=config['learning_rate'], max_depth=config['max_depth'])
