...
Z = 73.9*(1-0.4*(c/100)+0.12*(c/100)**2-0.02*(c/100)**3)*(1-1.1*(m/100)+0.35*(m/100)**2-0.03*(m/100)**3)*(1-1.7*(y/100)+1.1*(y/100)**2-0.32*(y/100)**3)+3.0*(c/100)*(y/100)+2.5*(c/100)*(m/100)*(y/100)
```
